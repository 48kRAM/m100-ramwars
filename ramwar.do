...
35 FORX=1TO4:P(X)=(RND(1)+.1)*B(X):PRINTCHR$(96+X);:PRINT USING " #####";A(X);:PRINT U(X):PRINT@(40*(X+1))+20,"";:PRINT USING"#####";A(X);:PRINT USING"$$####";P(X):NEXT
40 PRINT@240,"";:INPUT"(B)uy, (S)ell, (M)ove";I$:IF I$="b" OR I$="s" THEN INPUT"Type, Qty";G$,Q:H=ASC(G$)-96:IF I$="b" THEN 60 ELSE 70
50 IF I$="m" THEN CLS:FORX=1TO5:PRINTX;"- ";L$(X):NEXT:INPUT"Where to";F:GOTO 3059 REM Buying chips routine
